...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window, document, dat) {
	  ...
	  var imageSelect = gui.add(options, "image", ["at-the-moulin-rouge", "the-starry-night", "senecio", "mother-and-child", "the-bathers", "still-life-with-a-guitar"]);
	  ...
	  var Canvas = (function () {
	    ...
	    var render = function (image) {
	      ...
	      var data = context.getImageData.apply(context, _toArray(range)).data;
	      context.clearRect.apply(context, _toArray(range));
	      return data;
	    };
